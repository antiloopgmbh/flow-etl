...
final class MetadataTest extends TestCase
{
    ...
    {
        $this->assertEquals(
            Metadata::empty()->add('type', new ScalarType(ScalarType::INTEGER)),
            Metadata::empty()->add('type', new ScalarType(ScalarType::STRING))->merge(Metadata::empty()->add('type', new ScalarType(ScalarType::INTEGER)))
        );
    }
